...
const Dash = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get("http://65.1.93.221:3000/getdata", {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://65.1.93.221:3000/grant-access", {
                selectedDoctor
            }, {
                withCredentials: true, // Ensure cookies are sent
                headers: {
    ...
    const handleRevokeSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://65.1.93.221:3000/revoke-access", {
                revokeDoctor
            }, {
                withCredentials: true, // Ensure cookies are sent
                headers: {
